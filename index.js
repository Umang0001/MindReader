...
const handleDone = ()=>{
    ...
    switch (counter) {
        ...
        case 2:
            handleTimeout(`Now add ${randomNumber} to it !`)
            break;
...
const handleTimeout = (msgText)=>{
    ...
    if (counter == 6) {
        ...
        setTimeout(() => {
            cardInfo.innerHTML=`<button class="btn">
            ...
            <ul>
                <li>
                    <a href="https://wa.me/?text=Check%20out%20Umang's%20website:%20https%3A%2F%2Fumang0001.github.io/MindReader">
                ...
                <li>
                    <a href="instagram://share?text=Check%20out%20my%20website:%20https%3A%2F%2Fumang0001.github.io%2FMindReader%2F"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <li>
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fumang0001.github.io%2FMindReader%2F"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
